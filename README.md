...
### Шпаргалка по VBA
alt + f11 запуск редактора макросов в xslm документе. Слева инспектор проектов
ctrl + R запуск проджект-менеджера - среда программирования (не забыть на пкм добавить режим дебаггера)
insert -> UserForm  - добавить форму ввода. Ну и дальше понеслась мешанина окошек, лейблов, текстовых форм, шрифтов и т.д. и т.п. М-да.
...
5. **CSV** - добавил загрузку csv файла для наполнения базы данных
6. **Excel** - добавил 3 отдельных эндпойнта для с выгрузкой данных для работы с excel + vba.
